#-------------------------------------------------------------------
# FileName: U2U_CF_Cos.R
# INPUT: The User Business Review Score CSV file
# OUTPUT: Two graphs giving 
# Use: To perform User-User Collaborative Filtering using Cosine Similarity
#      We have used Cosine Similarity with implicit feeback prediction
...
ggsave(filename = 'MAE U2U CF Cosine.png'
       ,plot = P
       ,width = 12
       ,height = 9)
...
ggsave(filename = 'RMSE U2U CF Cosine.png'
       ,plot = P
       ,width = 12
       ,height = 9)
